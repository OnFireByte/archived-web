...
<div class="center" >
    <center>
        ...
        if(array_key_exists('countdown', $_POST)) { 
            $time = date("H")*3600 + date("i")*60 + date("s") + 20*60;
        ...
        <form method="post"> 
            ...
            <input type="submit" name="notdanger" class="button" value="NORMAL !" style="font-size:30px;" /><br>
            <input type="submit" name="countdown" class="button" value="COUNTDOWN !" style="font-size:30px;" />
        </form>
